...
- **AI Automation**: Integrated with OpenAI GPT-4o Mini for sentiment analysis of WhatsApp responses. IA works on specific stages (CONTATO, PROPOSTA, FORNECEDOR, FECHADO, PERDIDO) to automatically move Kanban opportunities based on sentiment and create intelligent notifications. It handles partial vs. total refusal scenarios to refine opportunity movement.
